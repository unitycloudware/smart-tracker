...
public class TestDataUtils {
    ...
    public static final String PROJECT_KEY = "UST";
    public static final String PROJECT_NAME = "UCW-Smart-Tracker";
    public static final String PROJECT_DESC = "Smart Tracker for monitoring of moving objects";
    ...
    public static final String DATA_STREAM_NAME = "ucw-smarttracker";
    public static final String DATA_STREAM_DESC = "Geolocation coordinates collected from GPS modules.";
    ...
    public Device getDevice() {
        return getDeviceManager().getDeviceByName(TestDataUtils.PROJECT_KEY, TestDataUtils.DEVICE_NAME);
    }
    ...
    public GeolocationData getDefaultLocation() {
        return GeolocationData.create(49.2789333, -123.124058, TimeUtils.getNow().getTime());
    }
}